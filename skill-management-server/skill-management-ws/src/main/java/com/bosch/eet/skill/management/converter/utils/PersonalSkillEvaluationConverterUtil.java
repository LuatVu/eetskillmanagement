...
@Component
public final class PersonalSkillEvaluationConverterUtil {

	private PersonalSkillEvaluationConverterUtil() {
		// prevent instantiation
	}

    public static SkillEvaluationDto convertToDTO(PersonalSkillEvaluation personalSkillEvaluation) {
        SkillEvaluation skillEvaluation = personalSkillEvaluation.getSkillEvaluation();
